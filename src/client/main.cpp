...
// 聊天客户端程序实现，main线程用做发送线程，子线程用做接收线程
int main(int argc,char **argv)
{
    if(argc < 3)
    {
        cerr << "command invail example: ./ChatClient 127.0.0.1 6000" <<endl;
        exit(-1);
    }
...
void mainMenu(int clientfd)
{
    ...
    while(isMainMenuRunning)
    {
        ...
        //调用相应命令的事件处理回调，mainMenu对修改粉笔，添加新功能不需要修改该函数
